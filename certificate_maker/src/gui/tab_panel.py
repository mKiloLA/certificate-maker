...
class TabPanel(tk.Frame):
    ...
    def __init__(self, master, terminal, set_create_tab=False) -> None:
        ...
        self.__zoom_file = "/Users/zakoster/Documents/playground/certificate-maker/10272023, Zoom Attendance Report, for Certificate Maker.csv" # None
        self.__webinar_file = "/Users/zakoster/Documents/playground/certificate-maker/Master Webinar Approval List, As of 09272023.xlsx" # None
    ...
    def action_performed(self, text: str) -> None:
        ...
        if text == "zoom":
            ...
            self.__email_folder = self.browse_for_file(title="Browse for Webinar JSON file.")
